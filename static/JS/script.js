...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const sonidos = [
    ...
    { title: "DO", src: "/static/Audio/1.mp3", class: "notas-blancas" },
    { title: "RE", src: "/static/Audio/2.mp3", class: "notas-blancas" },
    { title: "MI", src: "/static/Audio/3.mp3", class: "notas-blancas" },
    { title: "FA", src: "/static/Audio/4.mp3", class: "notas-blancas" },
    { title: "SOL", src: "/static/Audio/5.mp3", class: "notas-blancas" },
    { title: "LA", src: "/static/Audio/6.mp3", class: "notas-blancas" },
    { title: "SI", src: "/static/Audio/7.mp3", class: "notas-blancas" },
    { title: "DO", src: "/static/Audio/8.mp3", class: "notas-blancas" },
    { title: "RE", src: "/static/Audio/9.mp3", class: "notas-blancas" },
    { title: "MI", src: "/static/Audio/10.mp3", class: "notas-blancas" },
    { title: "FA", src: "/static/Audio/11.mp3", class: "notas-blancas" },
    { title: "SOL", src: "/static/Audio/12.mp3", class: "notas-blancas" },
    { title: "LA", src: "/static/Audio/13.mp3", class: "notas-blancas" },
    { title: "SI", src: "/static/Audio/14.mp3", class: "notas-blancas" },
    { title: "DO", src: "/static/Audio/15.mp3", class: "notas-blancas" },
    { title: "RE", src: "/static/Audio/16.mp3", class: "notas-blancas" },
    { title: "MI", src: "/static/Audio/17.mp3", class: "notas-blancas" },
    { title: "FA", src: "/static/Audio/18.mp3", class: "notas-blancas" },
    { title: "SOL", src: "/static/Audio/19.mp3", class: "notas-blancas" },
    { title: "LA", src: "/static/Audio/20.mp3", class: "notas-blancas" },
    { title: "SI", src: "/static/Audio/21.mp3", class: "notas-blancas" }
  ];
